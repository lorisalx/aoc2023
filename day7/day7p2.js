...
function computeScore(cards) {
  ...
  if (jokers === 5 || (values[0] + jokers === 5)) {    
    score += 60000000000;
  } else if (values[0] + jokers === 4) {
    score += 50000000000;
  } else if ((values[0] === 3 && values[1] === 2) || (values[0] === 2 && values[1] === 2 && jokers === 1) || (values[0] === 2 && values[1] === 1 && jokers === 2)) {
    score += 40000000000;
  } else if ((values[0] === 3 && values[1] === 1) || (values[0] === 2 && values[1] === 1 && jokers === 1) || (values[0] === 1 && values[1] === 1 && jokers === 2)) {
    score += 30000000000;
  } else if ((values[0] === 2 && values[1] === 2) || (values[0] === 2 && values[1] === 1 && jokers === 1)) {
    score += 20000000000;
  } else if ((values[0] === 2 && values[1] === 1) || (values[0] === 1 && values[1] === 1 && jokers === 1)) {
    score += 10000000000;
  } 
